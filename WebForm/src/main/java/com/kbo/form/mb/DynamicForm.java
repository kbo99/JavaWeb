...
import com.kbo.form.mb.test.BookProperty;

@ManagedBean(name="dynaFormController")
@ViewScoped 
public class DynamicForm implements java.io.Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = -744999851239928845L;
